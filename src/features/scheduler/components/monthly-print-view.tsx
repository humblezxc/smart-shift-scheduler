...
import { DayTaskLegend } from "./day-task-tag";
            ...
            <div className="mb-4 flex justify-between items-end">
                <div>
                    <h1 className="text-2xl font-bold uppercase tracking-wider">
                        {t("schedule")} — {format(date, "MMMM yyyy", { locale: dateLocale })}
                    </h1>
                    <p className="text-sm text-gray-500">Generated by Smart Shift Scheduler</p>
                    <DayTaskLegend className="text-[10px] text-gray-600 mt-1" />
                </div>
                ...
                <tr>
                    ...
                    {daysInMonth.map((day) => (
                        ...
                        >
                            ...
                            <div className="text-[8px] font-normal" aria-hidden>
